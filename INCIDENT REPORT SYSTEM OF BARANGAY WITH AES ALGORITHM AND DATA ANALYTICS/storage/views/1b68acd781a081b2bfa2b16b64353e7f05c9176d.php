    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <p class="lh-lg">After hearing the testimonies given and careful examination of the evidence presented in this case, award is hereby made as follows:
                <br><b><u> <?php echo e($arbitration_award->award_desc); ?>. </u></b>
            </p>
            <p class="lh-lg">Made this <b><?php echo e(date('jS', strtotime($arbitration_award->date_agreed))); ?></b> day of <b><?php echo e(date('F', strtotime($arbitration_award->date_agreed))); ?></b>, <b><?php echo e(date('Y', strtotime($arbitration_award->date_agreed))); ?></b>.</p>
...
</html><?php /**PATH C:\Users\eplum\Desktop\BRGY TANYAG\resources\views/blotter/pdf/arbitration-award.blade.php ENDPATH**/ ?>