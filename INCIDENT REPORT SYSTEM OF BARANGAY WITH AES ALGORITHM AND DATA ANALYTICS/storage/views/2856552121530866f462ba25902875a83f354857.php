...
<head>
    ...
    <title>Court Actions | BARRIO</title>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row d-flex justify-content-center mt-5 p-5">
                    <?php if(session()->has('filed_court_action')): ?>
                    <script>
                        Swal.fire({
                            icon: 'success',
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('blotter.court-actions-list')); ?>",
            columns: [{
                    data: 'case_no',
                    name: 'case_no'
                },
...
</html><?php /**PATH D:\xampp\htdocs\barrio\resources\views/blotter/court-actions.blade.php ENDPATH**/ ?>