...
<body style=" font-family: 'Times New Roman', serif !important;">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col">
                TO: <u><b><?php echo e($respondent->salutation); ?> <?php echo e($respondent->first_name); ?> <?php echo e($respondent->middle_name); ?> <?php echo e($respondent->last_name); ?></b></u><br>
                Respondent <br> <br>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <p class="lh-lg">You are hereby summoned to appear before me in person, together with your witnesses, on the <b><?php echo e($day); ?></b> day of <b><?php echo e($month); ?>, <?php echo e($year); ?></b> at <b><?php echo e($time); ?></b> o'clock in the morning/afternoon, then and there to answer to a complaint made before me, copy of which is attached hereto, for mediation/conciliation of your dispute with complainant/s.</p>
...
</html><?php /**PATH C:\Users\eplum\Desktop\BRGY TANYAG\resources\views/notice/pdf/summon.blade.php ENDPATH**/ ?>