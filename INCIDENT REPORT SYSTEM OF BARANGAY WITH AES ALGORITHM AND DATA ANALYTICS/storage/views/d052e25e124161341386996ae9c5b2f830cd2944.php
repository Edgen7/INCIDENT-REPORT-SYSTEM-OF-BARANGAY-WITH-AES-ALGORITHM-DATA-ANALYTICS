        ...
        <div class="container">
            ...
            <div class="row m-0">
                <div class="col-md-12 p-0 pt-4 pb-4">
                    <form action="<?php echo e(url('contactForm')); ?>" class="bg-light p-4 m-auto" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
...
</html><?php /**PATH C:\Users\eplum\Desktop\Thesis\BARRIO FILE\barrio\resources\views/user/home.blade.php ENDPATH**/ ?>