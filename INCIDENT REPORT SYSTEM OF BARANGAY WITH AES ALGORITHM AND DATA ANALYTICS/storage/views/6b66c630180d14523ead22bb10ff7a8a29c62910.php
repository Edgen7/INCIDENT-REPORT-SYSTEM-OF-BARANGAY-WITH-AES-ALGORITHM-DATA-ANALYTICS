...
<head>
    ...
    <title>Arbitration Award | BARRIO</title>
                    ...
                    <div class="card p-3 shadow">
                        <div class="row">
                            <div class="col">
                                ...
                                <p class="fs-4 fw-bold">Arbitration Award for Case <u><b>#<?php echo e($blotter_report->case_no); ?></b></u></p>
                        ...
                        <form method="post" action="<?php echo e(route('settlement.arbitration_award.store', $blotter_report->case_no)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="p-3">
                                    <p class="fw-bold text-primary">Arbitration Award Agreement</p>
                                    <textarea class="form-control" id="" placeholder="Agreement description" rows="5" name="agreement_desc" value=""><?php echo e(old('agreement_desc')); ?></textarea>
...
</html><?php /**PATH D:\xampp\htdocs\barrio\resources\views/settlement/arbitration_award.blade.php ENDPATH**/ ?>