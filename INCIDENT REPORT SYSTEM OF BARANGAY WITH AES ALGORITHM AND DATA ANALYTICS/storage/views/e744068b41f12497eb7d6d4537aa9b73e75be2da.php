...
<head>
    ...
    <title>Arbitration Hearings | BARRIO</title>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row d-flex justify-content-center  p-5">
                    <?php if(session()->has('agreement_arb')): ?>
                    <script>
                        Swal.fire({
                            icon: 'success',
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('settlement.arbitration.list')); ?>",
            columns: [{
                    data: 'case_no',
                    name: 'case_no'
                },
...
</html><?php /**PATH D:\xampp\htdocs\barrio\resources\views/settlement/show-arbitration.blade.php ENDPATH**/ ?>