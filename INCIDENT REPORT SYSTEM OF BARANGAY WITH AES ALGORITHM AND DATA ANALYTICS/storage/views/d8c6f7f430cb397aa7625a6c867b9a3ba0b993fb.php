...
<?php endif; ?>
            ...
            <div class="container-fluid">
                <div class="row d-flex justify-content-center mt-5 p-3">
                    ...
                    <?php if(session()->has('award_success')): ?>
                    <script>
                        Swal.fire({
                            icon: 'success',
                                ...
                                <div class="card p-3 shadow h-25">
                                    ...
                                    <ul class="list-group list-group-flush cases-to-execute">
                                        ...
                                        <li class="list-group-item list-group-item-action">
                                            <span class="badge bg-warning text-dark"> <?php echo e($data->case_no); ?> | <?php echo e($data->case_title); ?></span>
                                            <span class="badge rounded-pill bg-primary"> <?php echo e($supposed_date_of_exe[$loop->index]); ?> </span>
                                        </li>
                                ...
                                <div class="card p-3 shadow h-25 table-responsive">
                                    ...
                                    <div class="table-responsive-sm">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $persons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ind): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td scope="row"><span class="badge bg-light text-dark"><?php echo e($ind->last_name); ?></span></td>
                                                    <td><span class="badge bg-light text-dark"><?php echo e($ind->first_name); ?></span></td>
                                                    <td><span class="badge bg-light text-dark"><?php echo e($ind->middle_name[0]); ?></span></td>
                                                    <th class="text-center"><span class="badge bg-primary"><?php echo e($ind->total); ?></span></th>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="justify-content-end"><?php echo e($persons->links("pagination::bootstrap-5")); ?> </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('blotter.settled-list')); ?>",
            order: [
                [0, 'desc']
            ],
            columns: [{
...
</html><?php /**PATH C:\Users\eplum\Desktop\Thesis\BARRIO FILE\barrio\resources\views/blotter/settled-cases.blade.php ENDPATH**/ ?>