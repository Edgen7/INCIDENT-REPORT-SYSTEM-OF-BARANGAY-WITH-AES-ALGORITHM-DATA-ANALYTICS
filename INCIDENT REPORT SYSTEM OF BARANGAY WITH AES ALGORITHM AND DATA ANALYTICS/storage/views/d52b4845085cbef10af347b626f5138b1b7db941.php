...
<head>
    ...
    <title>File Court Action | BARRIO</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row d-flex justify-content-center  p-5">
                    ...
                    <div class="card p-3 shadow">
                        ...
                        <p class="fst-italic text-primary">Case #<?php echo e($blotter_report->case_no); ?>, <?php echo e($complainant->first_name); ?> <?php echo e($complainant->last_name); ?> vs. <?php echo e($respondent->first_name); ?> <?php echo e($respondent->last_name); ?></p>

                        <p class="fw-normal"><b>Latest Hearing: <span class="text-uppercase"><?php echo e($hearing_type->type_name); ?></span> on <?php echo e(date('F', strtotime($hearing->date_of_meeting))); ?> <?php echo e(date('j', strtotime($hearing->date_of_meeting))); ?>, <?php echo e(date('Y', strtotime($hearing->date_of_meeting))); ?>, <?php echo e(date('h:i A', strtotime($hearing->date_of_meeting))); ?></b></p><br>
                        ...
                        <div class="mb-3 mt-3">
                            <a href="<?php echo e(route('settlement.court-action-store', $blotter_report->case_no)); ?>" class="btn btn-danger">File Court Action </a>
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH D:\xampp\htdocs\barrio\resources\views/settlement/file-court-action.blade.php ENDPATH**/ ?>