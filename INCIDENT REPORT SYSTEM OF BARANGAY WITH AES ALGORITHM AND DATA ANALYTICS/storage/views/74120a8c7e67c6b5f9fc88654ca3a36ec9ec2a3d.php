...
<head>
    ...
    <title>Conciliation Settlement | BARRIO</title>
                ...
                <div class="row d-flex justify-content-center  p-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(route('settlement.show.conciliation')); ?>">Conciliations</a></li>
                    ...
                    <div class="card p-3 shadow">
                        <div class="row">
                            <div class="col">
                                ...
                                <p class="fs-4 fw-bold">Conciliation Hearing Record for Case <u><b>#<?php echo e($blotter_report->case_no); ?></b></u></p>
                        ...
                        <form method="post" action="<?php echo e(route('settlement.conciliation.store', $blotter_report->case_no)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="p-3">
...
</html><?php /**PATH D:\xampp\htdocs\barrio\resources\views/settlement/conciliation.blade.php ENDPATH**/ ?>